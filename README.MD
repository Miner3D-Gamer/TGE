...
- If set, tge will copy its files directly into the given provided directory instead of _creating a new_/_replacing an old_ tge folder (When -install_option is 3 or 4)