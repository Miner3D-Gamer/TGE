...
if assured_libraries:
 ...
 if json5_installed and hjson_installed:from.codec import codec;from.import random_generators as random;from.import file_operations
 if python_minifier_installed:from.import tbe,console_utils as console
 if pytube_installed and yt_dlp_installed:from.import internet
 from.import time_utils;from.import formatting_utils as formatting;from.import bool_operations
