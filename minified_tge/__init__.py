...
if assured_libraries:
 ...
 if json5_installed and hjson_installed:__all__.extend(['codec',_Y,_b]);from.codec import codec;from.import random_generators as random;from.import file_operations
 if python_minifier_installed:__all__.extend(['tbe',_X]);from.import tbe,console_utils as console
 if pytube_installed and yt_dlp_installed:__all__.append(_Z);from.import internet
