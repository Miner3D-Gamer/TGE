...
class NoInputType:'Custom class to indicate that no input type annotation is specified.'
...
class NoReturnType:'Custom class to indicate that no return type annotation is specified.'
