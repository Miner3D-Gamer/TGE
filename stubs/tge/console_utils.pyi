...
def write_sentences_to_console(text:list[str],type_delay:int|float,line_delay:int|float=.7)->None:...
def choose_from_text_menu(menu_list:Sequence[str],prompt:str='',destroy:bool=False)->int:...
def skip_line()->None:...
...
def matrix_rain(rows:int,columns:int,speed:int|float=.1,density:int|float=.2,duration:int|float|None=None,symbols:list[str]=['0','1'],callable_stop_if_return_true:Callable[...,bool]=...)->None:...
class SuppressPrint:
