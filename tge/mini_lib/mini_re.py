    ...
    while True:
        ...
        if this[0] == "\\":
            ...
            if capture:
                ...
                group = None
            sub_verbose = (
                verbose or add_flags & SRE_FLAG_VERBOSE
...
class RegexFlag:
    NOFLAG = 0
    ASCII = A = SRE_FLAG_ASCII
    IGNORECASE = I = SRE_FLAG_IGNORECASE
    LOCALE = L = SRE_FLAG_LOCALE
    UNICODE = U = SRE_FLAG_UNICODE
    MULTILINE = M = SRE_FLAG_MULTILINE
    DOTALL = S = SRE_FLAG_DOTALL
    VERBOSE = X = SRE_FLAG_VERBOSE
    TEMPLATE = T = SRE_FLAG_TEMPLATE
    DEBUG = SRE_FLAG_DEBUG
